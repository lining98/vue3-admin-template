<template>
  ...
  <el-card style="margin: 10px 0px">
    <el-button v-has="`btn.User.add`" type="primary" size="default" @click="addUser">添加用户</el-button>
    <el-button
    ...
    <!-- table展示用户信息 -->
    <el-table @selection-change="selectChange" style="margin: 10px 0px" border :data="tableData">
      <el-table-column type="selection" align="center" width="50"></el-table-column>
      <el-table-column label="#" align="center" type="index" width="50"></el-table-column>
      <el-table-column label="ID" align="center" prop="id"></el-table-column>
      <el-table-column label="用户名字" align="center" prop="username" width="150"></el-table-column>
      <el-table-column label="用户名称" align="center" prop="name" width="150"></el-table-column>
      <el-table-column label="用户角色" align="center" prop="roleName" show-overflow-tooltip width="150"></el-table-column>
      ...
      <el-table-column label="操作" fixed="right" width="300px" align="center">
        <template #="{ row, $index }">
          <el-button v-has="`btn.User.assgin`" size="small" icon="User" @click="setRole(row)">分配角色</el-button>
          <el-button v-has="`btn.User.update`" type="primary" size="small" icon="Edit" @click="updateUser(row)">编辑</el-button>
...
const deleteUser = async (userId: number) => {
  ...
  if (result.code == 200) {
    ...
    getHasUser(tableData.value.length > 1 ? pageNo.value : pageNo.value - 1)
  }
}
//table复选框勾选的时候会触发的事件
